<#
    ...
    whois, virustotal, xforce, TOR status, abuseIPDB

    TODO: clean up virustotal counts
    TODO: move API keys out of code?
...
$mainForm.Icon = "..\projectone\hnet.com-image.ico"
...
$installBtn.Location = New-Object System.Drawing.Point(250, 375)
$installBtn.Size = New-Object System.Drawing.Size(75, 23)
$installBtn.Height = 20
$installBtn.Width = 60
$installBtn.Text = 'Install'
$installBtn.Font = New-Object System.Drawing.Font("opensans", 8, [System.Drawing.FontStyle]::Regular)
...
Function SetupShortcut{
    $ShortcutPath = $Env:OneDriveCommercial + "\Desktop\p1.lnk"
    $WScriptObj = New-Object -ComObject ("WScript.Shell")
    $Shortcut = $WScriptObj.CreateShortcut($ShortcutPath)
    $Shortcut.IconLocation = "C:\Users\bsi534\OneDrive - Bulletproof\Pictures\hnet.com-image.ico"
    $Shortcut.TargetPath = "C:\Program Files\PowerShell\7\pwsh.exe"
    $Shortcut.Arguments = "-WindowStyle Hidden -ExecutionPolicy Bypass `"$Env:OneDriveCommercial\Desktop\p1.ps1`"" 
    $Shortcut.Save()
}
Function Clear-Info{
